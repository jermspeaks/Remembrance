...
feature "the user's homepage " do
  ...
  scenario "a user can return to their homepage by clicking the main logo on the top left" do
  end

  scenario "a user can log out and be redirected to the homepage" do
  end
end
